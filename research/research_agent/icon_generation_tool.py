...
class IconGenerationTool(Tool):
    ...
    def __init__(self, api_key: str = None):
        super().__init__()
        self.api_key = api_key or os.getenv("FLUX_API_KEY", "ms-967187ee-26d4-47ec-9cc2-a91dd846846e")
    ...
    def forward(self, concepts: str, model_id: str = None, style: str = None, context: str = "", image_url: str = None) -> str:
        """
        ...
        for idx, concept in enumerate(concept_list, start=1):
            ...
            try:
                ...
                resp = requests.post(self.base_url, data=data, headers=headers, timeout=120)
                ...
                safe_name = ''.join(ch for ch in concept if ch.isalnum() or ch in (' ', '-', '_')).rstrip()
                ...
                print(f"✅ Icon for '{concept}' saved to {filename} (model: {model_to_use})")
